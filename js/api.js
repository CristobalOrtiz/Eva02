...
{  
  ...
  relojEsfera.style.width = '35%';
  relojEsfera.style.height = '35%';
  relojEsfera.style.border = '2px solid white';
  ...
  segundos.style.border = '1px solid white';
  ...
  minutos.style.border = '1px solid white';
  ...
  horas.style.border = '1px solid red';
